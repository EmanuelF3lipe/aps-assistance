import { FiSearch, FiX, FiPlus, FiTag, FiFileText, FiList, FiGrid } from 'react-icons/fi'

export default function Header({ searchQuery, onSearch, onClearSearch, onNewFile, onShowDashboard, onShowTags, onShowRelatorios, onSearchByTag, mainView, onSwitchView }) {
